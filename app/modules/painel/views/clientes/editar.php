					...
					<div class="row">
						<div class="col-md-3">
							...
							<div class="btn btn-file text-center" style="display: block;">
								<img style="max-height: 110px;min-height: 110px;" class="profile-user-img img-responsive" src="<?php echo BASE_URL ?>app/assets/images/clientes/<?php echo mb_strtolower($tableInfo['id_client'], 'UTF-8') ?>/<?php echo mb_strtolower($tableInfo['cli_photo'], 'UTF-8') ?>" alt="">
